package com.napzak.common.auth.aop;
...
public class AuthorizedRoleAspect {
	...
	@Before("@annotation(com.napzak.common.auth.annotation.AuthorizedRole) || @within(com.napzak.common.auth.annotation.AuthorizedRole)")
	...
	@After("@annotation(com.napzak.common.auth.annotation.AuthorizedRole) || @within(com.napzak.common.auth.annotation.AuthorizedRole)")
