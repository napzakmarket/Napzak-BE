...
@Table(name = ProductReportTableConstants.TABLE_PRODUCT_REPORT)
@Entity
@Getter
...
public class ProductReportEntity {
	...
	@Column(name = ProductReportTableConstants.COLUMN_ID)
	private Long id;

	@Column(name = ProductReportTableConstants.COLUMN_REPORTER_ID, nullable = false)
	private Long reporterId;

	@Column(name = ProductReportTableConstants.COLUMN_REPORTED_PRODUCT_ID, nullable = false)
	private Long reportedProductId;

	@Column(name = ProductReportTableConstants.COLUMN_REPORTED_PRODUCT_IMAGES, nullable = false, columnDefinition = "TEXT")
	private String reportedProductImages;

	@Column(name = ProductReportTableConstants.COLUMN_REPORTED_PRODUCT_TITLE, nullable = false)
	private String reportedProductTitle;

	@Column(name = ProductReportTableConstants.COLUMN_REPORTED_PRODUCT_DESCRIPTION, nullable = false)
	private String reportedProductDescription;

	@Column(name = ProductReportTableConstants.COLUMN_REPORT_TITLE, nullable = false)
	private String reportTitle;

	@Column(name = ProductReportTableConstants.COLUMN_REPORT_DESCRIPTION, nullable = false)
	private String reportDescription;

	@Column(name = ProductReportTableConstants.COLUMN_REPORT_CONTACT, nullable = false)
	private String reportContact;

	@Column(name = ProductReportTableConstants.COLUMN_CREATED_AT, nullable = false)
