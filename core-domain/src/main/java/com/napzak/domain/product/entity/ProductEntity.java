...
public class ProductEntity {
	...
	@Column(name = ProductTableConstants.COLUMN_TITLE, nullable = false, columnDefinition = "varchar(50)")
	private String title;

	@Column(name = ProductTableConstants.COLUMN_DESCRIPTION, nullable = false, columnDefinition = "varchar(250)")
	private String description;

	@Enumerated(EnumType.STRING)
	@Column(name = ProductTableConstants.COLUMN_TRADE_TYPE, nullable = false)
	private TradeType tradeType;

	@Column(name = ProductTableConstants.COLUMN_PRICE, nullable = false)
	private int price;

	@Column(name = ProductTableConstants.COLUMN_CREATED_AT, nullable = false)
	private final LocalDateTime createdAt = LocalDateTime.now();

	@Column(name = ProductTableConstants.COLUMN_UPDATED_AT, nullable = true)
	private LocalDateTime updatedAt;

	@Column(name = ProductTableConstants.COLUMN_VIEW_COUNT, nullable = false)
	private int viewCount = 0;

	@Enumerated(EnumType.STRING)
	@Column(name = ProductTableConstants.COLUMN_TRADE_STATUS, nullable = false)
	private TradeStatus tradeStatus;

	@Column(name = ProductTableConstants.COLUMN_IS_PRICE_NEGOTIABLE, nullable = false)
	private Boolean isPriceNegotiable = false;

	@Column(name = ProductTableConstants.COLUMN_IS_DELIVERY_INCLUDED, nullable = false)
	private Boolean isDeliveryIncluded = false;

	@Column(name = ProductTableConstants.COLUMN_STANDARD_DELIVERY_FEE, nullable = false)
	private int standardDeliveryFee = 0;

	@Column(name = ProductTableConstants.COLUMN_HALF_DELIVERY_FEE, nullable = false)
	private int halfDeliveryFee = 0;

	@Enumerated(EnumType.STRING)
	@Column(name = ProductTableConstants.COLUMN_PRODUCT_CONDITION, nullable = true)
	private ProductCondition productCondition;

	@Column(name = ProductTableConstants.COLUMN_INTEREST_COUNT, nullable = false)
	private int interestCount = 0;

	@Column(name = ProductTableConstants.COLUMN_CHAT_COUNT, nullable = false)
	private int chatCount = 0;

	@Column(name = ProductTableConstants.COLUMN_IS_VISIBLE, nullable = false)
	private Boolean isVisible = true;

	@Column(name = ProductTableConstants.COLUMN_STORE_ID, nullable = false)
	private Long storeId;

	@Column(name = ProductTableConstants.COLUMN_GENRE_ID, nullable = false)
